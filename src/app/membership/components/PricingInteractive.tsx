  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-24 md:py-32 bg-background overflow-hidden font-display">
        {/* Simplified Background - Static and lightweight */}
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
          <div className="absolute top-[0%] right-[0%] w-[300px] h-[300px] rounded-full"
            style={{ background: 'radial-gradient(circle, hsla(177, 37%, 27%, 0.05) 0%, transparent 70%)' }} />
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative">
              {/* Simplified Glow */}
              <div className="absolute -inset-1 bg-gradient-to-r from-accent/5 via-primary/5 to-accent/5 rounded-[3rem] blur-xl opacity-50" />

              <div className="relative bg-card rounded-[2.5rem] p-8 md:p-12 border border-border/50 shadow-xl">
