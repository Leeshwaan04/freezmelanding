      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="font-headline text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground mb-6">
            Member-First Pricing & Plans
          </h1>
          <p className="font-body text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Professional matchmaking shouldn't be a luxury for the few. Choose a plan that fits your lifestyle, from verified profile inclusion to full-service management.
          </p>
          <div className="mt-8 inline-flex items-center gap-2 px-6 py-3 bg-accent/10 rounded-full">
            <span className="font-body text-sm font-medium text-accent-foreground">
              Accessible Entry • Flexible Upgrades • Results Driven
            </span>
          </div>
        </div>
      </div>
